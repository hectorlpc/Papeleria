...
@section('content')
   ...
   <div class="card text-black bg-white mb-3">
       <div class="card-header bg-dark text-white"><center><h4>Alta Marca</h4></div>
     <div class="card-body">
    <br>
   <form method="post" action="{{url('Marca/store')}}">
        {{ csrf_field() }}
    <div class="form-group row">
     ...
     <div class="form-group row">
       ...
       <div class="col-sm-9">
         <input type="text" class="form-control" id="inputEmail3" placeholder="Marca" name="Nombre">
       </div>
     </div>
