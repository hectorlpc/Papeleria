...
@section('content')
   ...
   <div class="card text-black bg-white mb-3">
       <div class="card-header bg-dark text-white"><center>Agregar Tipo del Producto</div>
     <div class="card-body">

   <form method="post" action="{{url('Tipo/store')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
     ...
     <div class="form-group row">
       ...
       <div class="col-sm-9">
         <textarea class="form-control" id="exampleTextarea" rows="3" placeholder="..." name="Desc_Tipo"></textarea>
       </div>
     </div>
     <div class="form-group row">
